...
\vspace{0.3em}
\large Version 1.2 — January 2025}
...
\begin{quote}
\textbf{Changelog v1.2}: Added MEV protection documentation. Corrected finality description—QuantumHarmony provides deterministic BFT finality via the Coherence Gadget, not probabilistic finality.
\end{quote}
...
\begin{itemize}
  \item Mock entropy sources
  \item Full BFT execution preserved
  \item Falcon1024 signatures
