...
\vspace{0.3em}
\large Version 1.4 — January 2025}
...
\begin{quote}
\textbf{Changelog v1.4}: Added Quantum P2P networking section (ML-KEM-1024, Falcon-1024, QKD hardware interface). Expanded Proof of Coherence with P2P integration details.
