...
\vspace{0.3em}
\large Version 1.7 — January 2025\\
\vspace{0.2em}
\small DOI: Pending Zenodo Publication}
...
\begin{quote}
\textbf{Changelog v1.7}: Clarified PQC costs—we avoid migration overhead but still have raw PQC signature size, mitigated via toroidal parallelization.
